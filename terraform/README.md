...
1. (Optional) If you want to replace the inbuilt OSS Redis with a fully managed instance of:
   ...
   * [Redis Enterprise database instance via Google Cloud Marketplace](https://console.cloud.google.com/marketplace/product/redis-marketplace-isaas/redis-enterprise-cloud-flexible-plan): you can change the value of `redis-enterprise = false` to `redis-enterprise = true` in this `terraform.tfvars` file.
