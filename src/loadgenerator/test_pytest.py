...
BASE_URL = "http://" + os.environ.get("FRONTEND_ADDR", "10.2.10.237:8081")#internal or external test
...
def test_session():
    order=[test_index,test_set_currency,test_browse_product,test_add_to_cart,test_view_cart,test_add_to_cart,test_checkout]
