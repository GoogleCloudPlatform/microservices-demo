...
type TranslationResponse struct {
	...
	TranslationResult string `protobuf:"bytes,1,opt,name=translation_result,json=translationResult,proto3" json:"translation_result,omitempty"`
}
...
type GetSupportedLanguagesResponse struct {
	...
	LanguageCodes []string `protobuf:"bytes,1,rep,name=language_codes,json=laanguageCodes,proto3" json:"language_codes,omitempty"`
}
...
func (x *GetSupportedLanguagesResponse) GetLanguageCodes() []string {
	if x != nil {
...
type TranslationRequest struct {
	...
	TranslationKey string `protobuf:"bytes,2,opt,name=translation_key,json=translationKey,proto3" json:"translation_key,omitempty"`
...
// func (x *TranslationRequest) GetFrom() *TranslationResponse {
// 	if x != nil {
// 		return x.From
// 	}
// 	return nil
...
// func (x *TranslationRequest) GetToCode() string {
// 	if x != nil {
// 		return x.ToCode
// 	}
// 	return ""
