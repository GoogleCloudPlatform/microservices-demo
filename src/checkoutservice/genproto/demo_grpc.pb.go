...
const (
	LanguageService_GetSupportedLanguages_FullMethodName = "/hipstershop.LanguageService/GetSupportedLanguages"
	LanguageService_Translate_FullMethodName                = "/hipstershop.LanguageService/Translate"
)
...
type LanguageServiceClient interface {
	GetSupportedLanguages(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetSupportedLanguagesResponse, error)
...
func (c *languageServiceClient) GetSupportedLanguages(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetSupportedLanguagesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSupportedLanguagesResponse)
	err := c.cc.Invoke(ctx, LanguageService_GetSupportedLanguages_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *languageServiceClient) Translate(ctx context.Context, in *TranslationRequest, opts ...grpc.CallOption) (*TranslationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslationResponse)
	err := c.cc.Invoke(ctx, LanguageService_Translate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LanguageServiceServer interface {
	GetSupportedLanguages(context.Context, *Empty) (*GetSupportedLanguagesResponse, error)
...
func (UnimplementedLanguageServiceServer) GetSupportedLanguages(context.Context, *Empty) (*GetSupportedLanguagesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSupportedLanguages not implemented")
}
func (UnimplementedLanguageServiceServer) Translate(context.Context, *TranslationRequest) (*TranslationResponse, error) {
...
func _LanguageService_GetSupportedLanguages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LanguageServiceServer).GetSupportedLanguages(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LanguageService_GetSupportedLanguages_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LanguageServiceServer).GetSupportedLanguages(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _LanguageService_Translate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LanguageServiceServer).Translate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LanguageService_Translate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LanguageServiceServer).Translate(ctx, req.(*TranslationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LanguageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hipstershop.LanguageService",
	HandlerType: (*LanguageServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetSupportedLanguages",
			Handler:    _LanguageService_GetSupportedLanguages_Handler,
		},
		{
			MethodName: "Translate",
			Handler:    _LanguageService_Translate_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "demo.proto",
