...
# Commented these out to use AlloyDB IAM authentication instead of password
...
def create_app():
    ...
    def talkToGemini():
        ...
        vector_search_prompt = f""" This is the user's request: {prompt} Find the most relevant items for that prompt."""
