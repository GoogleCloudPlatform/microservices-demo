...
class UnacceptedCreditCard extends CreditCardError {
  constructor(cardType) {
    super(`Sorry, we cannot process ${cardType} ` +
...
class ExpiredCreditCard extends CreditCardError {
  constructor(number, month, year) {
    super(`Your credit card (ending ${number.substr(-4)}) ` +
...
module.exports = function charge(request) {
  ...
  // Only VISA and mastercard is accepted,other card types(AMEX, dinersclub)
  // will throw UnacceptedCreditCard error.
