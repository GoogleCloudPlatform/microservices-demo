...
func (fe *frontendServer) setCurrencyHandler(w http.ResponseWriter, r *http.Request) {
	_, span := startSpan("setCurrency", &r)
	defer span.End()
	log := r.Context().Value(ctxKeyLog{}).(logrus.FieldLogger)
