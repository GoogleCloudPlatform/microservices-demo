...
```bash
export TF_STATE_BUCKET=blackfriday-terraform-state-newacct-eus1-20260306
```
...
```bash
kubectl -n onlineboutique get svc frontend-external -w
```

Wait until ELB hostname appears.
