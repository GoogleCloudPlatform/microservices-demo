...
build:
	...
	docker build --tag rookout/microservices-demo-checkoutservice:latest --tag rookout/microservices-demo-checkoutservice:${PUBLISH_VERSION} --file ./src/checkoutservice/Dockerfile ./src/checkoutservice --build-arg GIT_COMMIT=${GIT_COMMIT} --build-arg GIT_ORIGIN=${GIT_ORIGIN} --build-arg SONARIO_GH_TOKEN=${SONARIO_GH_TOKEN}
	...
	docker build --tag rookout/microservices-demo-frontend:latest --tag rookout/microservices-demo-frontend:${PUBLISH_VERSION} --file ./src/frontend/Dockerfile ./src/frontend --build-arg GIT_COMMIT=${GIT_COMMIT} --build-arg GIT_ORIGIN=${GIT_ORIGIN} --build-arg SONARIO_GH_TOKEN=${SONARIO_GH_TOKEN}
	...
	docker build --tag rookout/microservices-demo-productcatalogservice:latest --tag rookout/microservices-demo-productcatalogservice:${PUBLISH_VERSION} --file ./src/productcatalogservice/Dockerfile ./src/productcatalogservice --build-arg GIT_COMMIT=${GIT_COMMIT} --build-arg GIT_ORIGIN=${GIT_ORIGIN} --build-arg SONARIO_GH_TOKEN=${SONARIO_GH_TOKEN}
	...
	docker build --tag rookout/microservices-demo-shippingservice:latest --tag rookout/microservices-demo-shippingservice:${PUBLISH_VERSION} --file ./src/shippingservice/Dockerfile ./src/shippingservice --build-arg GIT_COMMIT=${GIT_COMMIT} --build-arg GIT_ORIGIN=${GIT_ORIGIN} --build-arg SONARIO_GH_TOKEN=${SONARIO_GH_TOKEN}
